...
class Class : public ObjectWrapperBase {
  public:
     ...
     *
     */
    static Class forName(std::string &stringParam, bool booleanParam,
     ...
     *
     */
    static Class forName(jni::Object &module, std::string &stringParam);
...
class ClassLoader : public ObjectWrapperBase {
  public:
     ...
     *
     */
    Class loadClass(std::string &stringParam);
     ...
     *
     */
    std::string findLibrary(std::string &stringParam);
...
class System : public ObjectWrapperBase {
  public:
     ...
     *
     */
    static std::string mapLibraryName(std::string &stringParam);
...
/*!
 * Wrapper for java.lang.Math objects.
 */
class Math : public ObjectWrapperBase {
  public:
    using ObjectWrapperBase::ObjectWrapperBase;
    static constexpr const char *getTypeName() noexcept {
    ...
    /*!
     * Wrapper for the ceil static method
     *
     * Java prototype:
     ...
     *
     */
    static double ceil(double doubleParam);
