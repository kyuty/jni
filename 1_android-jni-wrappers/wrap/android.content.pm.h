...
class PackageManager : public ObjectWrapperBase {
  public:
     ...
     *
     */
    PackageInfo getPackageInfo(std::string &stringParam, int32_t intParam);

    /*!
     * Wrapper for the getPackageInfo method
     *
     * Java prototype:
     * `public android.content.pm.PackageInfo getPackageInfo(java.lang.String,
     * android.content.pm.PackageManager$PackageInfoFlags) throws
     * android.content.pm.PackageManager$NameNotFoundException;`
     *
     * JNI signature:
     ...
     *
     */
    PackageInfo getPackageInfo(std::string &stringParam,
     ...
     *
     */
    PackageInfo getPackageInfo(jni::Object &versionedPackage, int32_t intParam);
     ...
     * getPackageInfo(android.content.pm.VersionedPackage,
     * android.content.pm.PackageManager$PackageInfoFlags) throws
     * android.content.pm.PackageManager$NameNotFoundException;`
     *
     * JNI signature:
     ...
     *
     */
    PackageInfo getPackageInfo(jni::Object &versionedPackage,
                               jni::Object &packageManager_PackageInfoFlags);
     ...
     *
     */
    ApplicationInfo getApplicationInfo(std::string &stringParam,
                                       int32_t intParam);
     ...
     * getApplicationInfo(java.lang.String,
     * android.content.pm.PackageManager$ApplicationInfoFlags) throws
     * android.content.pm.PackageManager$NameNotFoundException;`
     *
     * JNI signature:
     ...
     */
    ApplicationInfo
    getApplicationInfo(std::string &stringParam,
     ...
     * queryIntentServices(android.content.Intent,
    ...
    queryIntentServices(Intent &intent,
                        jni::Object &packageManager_ResolveInfoFlags);
    ...
    struct Meta : public MetaBaseDroppable {
        ...
        jni::method_t getPackageInfo3;
        jni::method_t getApplicationInfo;
        jni::method_t getApplicationInfo1;
        jni::method_t queryIntentServices;
        jni::method_t queryIntentServices1;
