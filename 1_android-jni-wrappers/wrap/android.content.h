...
class Context : public ObjectWrapperBase {
  public:
     ...
     *
     */
    void startActivity(Intent &intent, os::Bundle &bundle);
     ...
     *
     */
    Context createPackageContext(std::string &stringParam, int32_t intParam);
...
class ComponentName : public ObjectWrapperBase {
  public:
     ...
     *
     */
    static ComponentName construct(std::string &stringParam,
     ...
     *
     */
    static ComponentName construct(Context &context, std::string &stringParam);
     ...
     *
     */
    static ComponentName construct(Context &context,
     ...
     *
     */
    static ComponentName construct(jni::Object &parcel);
...
class Intent : public ObjectWrapperBase {
  public:
     ...
     *
     */
    static Intent construct(std::string &stringParam);
     ...
     *
     */
    static Intent construct(std::string &stringParam, net::Uri &uri);
     ...
     *
     */
    static Intent construct(Context &context, java::lang::Class &classParam);
     ...
     */
    static Intent construct(std::string &stringParam, net::Uri &uri,
                            Context &context, java::lang::Class &classParam);
     ...
     *
     */
    Intent setFlags(int32_t intParam);
...
class ContentResolver : public ObjectWrapperBase {
  public:
     ...
     *
     */
    database::Cursor query(net::Uri &uri, jni::Array<std::string> &stringArray,
