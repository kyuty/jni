...
class BaseBundle : public ObjectWrapperBase {
  public:
     ...
     *
     */
    bool containsKey(std::string &stringParam);
     ...
     *
     */
    std::string getString(std::string &stringParam);
     ...
     *
     */
    std::string getString(std::string &stringParam, std::string &stringParam1);
...
class ParcelFileDescriptor : public ObjectWrapperBase {
  public:
     ...
     *
     */
    static ParcelFileDescriptor adoptFd(int32_t intParam);
